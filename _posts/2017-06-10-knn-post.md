...
so is your test time. The other disadvantage is that it is used to rgb values to measure the distance and this results with color matching, e.g. picture of the airplane on the air mostly have blue color because
